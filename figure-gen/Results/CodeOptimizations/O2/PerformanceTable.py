...
LOCAL_NAME  = "createPixelTripletTopCandidates"
LOCAL_LABEL = r"\texttt{createPixelTripletTopCandidates}"
LOCAL_TAGS  = {"Baseline": "LocalTime2", VARIANT: "LocalTime1"}

CALLGRIND_TARGETS = {
    "Pixel": ["createTripletTopCandidates"],
    "Strip": ["createTripletTopCandidates"],
}
...
def main() -> None:
    ...
    df_local  = load_all_local(VARIANTS, csv_tag_for=LOCAL_TAGS, name_in_csv=LOCAL_NAME)
