...
workflow.run(
    ...
    DataDir="Results/CodeOptimizations/clean",
...
workflow.copy_required_dirs()
workflow.copy_dir("CodeOptimizations/_baseline/localTiming/createDoubletsImpl")
workflow.build_environment()
...
workflow.copy_required_dirs()
workflow.copy_dir("CodeOptimizations/_baseline/localTiming/createTripletTopCandidates")
workflow.build_environment()
