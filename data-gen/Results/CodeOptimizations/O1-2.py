...
workflow.copy_dir("CodeOptimizations/O1-2/_baseline")
...
workflow.run(
    ...
    DataDir="Results/CodeOptimizations/O1-2/clean",
...
workflow.copy_required_dirs()
workflow.copy_dir("CodeOptimizations/O1-2/localTiming/createDoubletsImpl")
workflow.build_environment()
...
workflow.copy_required_dirs()
workflow.copy_dir("CodeOptimizations/O1-2/localTiming/createPixelTripletTopCandidates")
workflow.build_environment()
...
workflow.run(
    ...
    Parsers=[
        ("TimerParser.py", "PixelSeedingLocalTime2.csv", 0),
        ("TimerParser.py", "StripSeedingLocalTime2.csv", 1),
    ],
    LogFileNames=[
        "PixelSeedingLocalTime2",
        "StripSeedingLocalTime2",
    ],
    PrepareEnvironment=False,
)
