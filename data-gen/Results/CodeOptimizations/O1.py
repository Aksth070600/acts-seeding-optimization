...
workflow.copy_dir("CodeOptimizations/O1/_baseline")
...
workflow.run(
    ...
    DataDir="Results/CodeOptimizations/O1/clean",
...
workflow.copy_required_dirs()
workflow.copy_dir("CodeOptimizations/O1/localTiming/createDoubletsImpl")
workflow.build_environment()
...
workflow.copy_required_dirs()
workflow.copy_dir("CodeOptimizations/O1/localTiming/createTripletTopCandidates")
workflow.build_environment()
