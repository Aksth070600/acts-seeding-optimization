...
workflow.copy_dir("CodeOptimizations/O2/_baseline")
...
workflow.run(
    ...
    DataDir="Results/CodeOptimizations/O2/clean",
...
workflow.copy_required_dirs()
workflow.copy_dir("CodeOptimizations/O2/localTiming/createTripletTopCandidates")
workflow.build_environment()
