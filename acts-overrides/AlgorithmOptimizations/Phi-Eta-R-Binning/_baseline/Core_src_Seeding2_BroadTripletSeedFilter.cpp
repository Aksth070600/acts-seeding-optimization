...
bool BroadTripletSeedFilter::sufficientTopDoublets(
  ...
  // (works for both cylindrical and spherical - z always stored in zr[0])
  ...
  // Check radius (same for both coordinate systems - r always at zr[1])
...
void BroadTripletSeedFilter::filterTripletTopCandidates(
  ...
  // Calculate z origin using z and r (both directly from zr column)
