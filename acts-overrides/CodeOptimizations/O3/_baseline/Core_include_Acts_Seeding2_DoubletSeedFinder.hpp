...
class DoubletsForMiddleSp {
 public:
  ...
  /// @param indexAndCotTheta Output vector containing sorted index and cotTheta
  ///   pairs
  ...
  /// Sort doublets by cotTheta within given range using a directly-provided
  /// comparator.
  /// @param range Index range to sort within
  /// @param indexAndCotTheta Output vector containing sorted index and
  ///   cotTheta pairs
  /// @param comp Comparator to use for ordering
  template <typename Comparator>
  void sortByCotThetaDirect(
    ...
    std::sort(indexAndCotTheta.begin(), indexAndCotTheta.end(),
