...
void SeedFinder<external_spacepoint_t, grid_t, platform_t>::createSeedsForGroup(
  ...
  for (const external_spacepoint_t* spM : middleSPs) {
    ...
    {
      TIMER("Seeding-createSeedsFromGroups-MiddleTops");
    ...
    {
      TIMER("Seeding-createSeedsFromGroups-MiddleBottoms");
    ...
    // filter candidates
    {
      TIMER("Seeding-createSeedsFromGroups-TripletEvaluation");
    ...
    {
      TIMER("Seeding-createSeedsFromGroups-SeedFiltering");
...
SeedFinder<external_spacepoint_t, grid_t, platform_t>::getCompatibleDoublets(
    ...
    boost::container::small_vector<Neighbour<grid_t>, detail::ipow(3, grid_t::DIM)>& otherSPsNeighbours,
